...
public class Artist_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        BottomNavigationView bottomNavigationView = findViewById(R.id.artistBottomNavBar);
...
//                    switch to now playiing activity if ow playing button is clicked
                    case R.id.nowplaying:
                        Intent intent = new Intent(Artist_Activity.this, NowPlaying_Activity.class);
                        startActivity(intent);
                        break;
//                        switch to search activity if search button is clicked
                    case R.id.search:
                        Intent intent1 = new Intent(Artist_Activity.this, Search_Activity.class);
                        startActivity(intent1);
                        break;
//                        switch to library activity if library button is clicked
                    case R.id.library:
                        Intent intent2 = new Intent(Artist_Activity.this, MainActivity.class);
